      ...
      <AnimatePresence mode="wait">
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 px-6 py-3 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium flex items-center gap-2 shadow-lg hover:shadow-xl transition-shadow"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            {/* Rainbow glow effect */}
            <div className="absolute inset-0 rounded-full blur-xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 opacity-75 -z-10 animate-pulse" />
